...
Elige una opción:  ------->  ''')
        ...
        if Menu == '1':
            ...
            for i in range(len(ProductsList)-1):
                if ProductsList[i].getGanancia() < ProductsList[i+1].getGanancia():
                    ProductsList[i], ProductsList[i+1] = ProductsList[i+1], ProductsList[i]
